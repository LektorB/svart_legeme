...
from dash_bootstrap_templates import load_figure_template  # Bruker bootstrap-template i plotly grafene
...
def piler(temp, alfa):
    ...
    fig.add_annotation(ax=0.7, axref='x', ay=1.8, ayref='y',
                       ...
                       arrowwidth=tyk, arrowhead=7, arrowsize=0.3, text="Solinstråling", arrowcolor="yellow",
                       arrowside='none')
    ...
    if alfa * tyk > 0.1:
        fig.add_annotation(ax=0.5, axref='x', ay=1.78, ayref='y',
                           ...
                           text="Reflektert sollys", arrowcolor="yellow", align='left')
